...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            pageTitle: 'ABDELRAHMAN HAMOUDA - PORTFOLIO', myName: 'ABDELRAHMAN HAMOUDA', 'nav-home': 'Home', 'nav-about': 'About', 'nav-skills': 'Skills', 'nav-certifications': 'Certifications', 'nav-portfolio': 'Portfolio', 'nav-cvs': 'Resume', 'nav-contact': 'Contact', 'lang-toggle-text': 'AR', 'typing-words': 'Software Engineer | Frontend Developer / UI & UX Designer | Backend (Laravel)',
            ...
            'cert1-title': 'Associate Android Developer – Google', 'cert2-title': 'Google IT Support – Google | 2024', 'cert3-title': 'Fundamentals of Digital Marketing – Google | 2024', 'cert4-title': 'Associate Cloud Engineer', 'cert5-title': 'Certified in Node.js, Nest.js, PostgreSQL, GraphQL & Security', 'cert6-title': 'Mastering Kali Linux for Ethical Hackers', 'cert7-title': 'Python Essentials 1 – Cisco & OpenEDG Python Institute', 'cert8-title': 'Introduction to Cybersecurity (Cisco & Udemy)', 'cert9-title': 'Flutter Clean Architecture Certification', 'cert10-title': 'Web Development Course', 'cert11-title': 'Professional Adobe Photoshop CC Course With Advanced Training', 'cert12-title': 'ICDL – Maaref Academy', 'cert13-title': 'HTML Formatting Tags Techniques – Mind Luster', 'cert14-title': 'Python – Udemy', 'cert15-title': 'Java – Udemy', 'cert16-title': 'C++ – Udemy', 'cert17-title': 'Intro to AI – Edraak Platform', 'cert18-title': 'Graphic Design – Maaref Academy', 'cert19-title': 'Logo Design – Maaref Academy', 'cert20-title': 'English – Maaref Academy', 'cert21-title': 'Soft Skills – Mind Luster', 'cert22-title': 'Soft Skills 2 – Maaref Academy', 'cert23-title': 'Querying Data with Transact-SQL',
            'portfolio-websites': 'Websites', 'portfolio-designs': 'Designs', 'portfolio-view-design': 'View Design',
            'p1-title': 'PORTFOLIO', 'p2-title': 'PRO COURSES', 'p3-title': 'AMAZONE CLONE', 'p4-title': 'HEADPHONES STORE', 'p5-title': 'YOUTUBE CLON', 'p6-title': 'EDUCATION PLATFORM', 'p7-title': 'IMAGES SLIDES', 'p8-title': 'PLANETS WEBSITE', 'p9-title': 'SPIRO SPATIS DESIGN', 'p10-title': 'ANIMATION CANS', 'p11-title': 'COLOR LOGIN', 'p12-title': 'RED LOGIN', 'p13-title': 'BLACK LOGIN', 'p14-title': 'MAN LOGIN', 'p15-title': 'IOS LOGIN', 'p16-title': 'ZOOM WEBSITE PIC', 'p17-title': 'WHITE BOARD', 'p18-title': 'SOCIAL MEDIA BUTTONS', 'p19-title': 'GLASSES LIST', 'p20-title': 'ANALYSIS', 'p21-title': 'MOON ANIMATION', 'p22-title': 'XO GAME', 'p23-title': 'COINSHIFT', 'p24-title': 'FITNESS', 'p25-title': 'MANAGE COINS', 'p26-title': 'TIME OF PRAYER', 'p27-title': 'GUESS FOOD', 'p28-title': 'TAGWEED', 'p29-title': 'IZAA OF QURAAN',
    ...
    'cv-dev-download': 'تحميل السيرة الذاتية (مطور)',
